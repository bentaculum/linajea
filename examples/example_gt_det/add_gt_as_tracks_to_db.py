...
def add_tracks_to_db(
        tracks_file, zarr_file, db_host, db_name,
        has_div_state=False, has_radius=False,
        has_name=False, frames=None, points=False, scale_z=1.0):
    ...
    movement_vectors = zarr.open(zarr_file, 'r', path="volumes/movement_vectors")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--scale_z", type=int, default=1,
    ...
    add_tracks_to_db(
        args.tracks, args.zarr_file, db_host, db_name,
